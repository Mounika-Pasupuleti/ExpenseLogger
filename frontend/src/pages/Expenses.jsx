...
function Expenses() {
    ...
    const highestExpense = totalTransactions
        ? Math.max(...expenses.map((item) => Math.abs(Number(item.amount))))
        : 0;
    const averageExpense = totalTransactions ? expenseAmt / totalTransactions : 0;
    ...
    return (
        ...
        <style>{`
            ...
            .snapshot-income { color: #16A34A; font-weight: 600; margin: 4px 0; }
            .snapshot-expense { color: #DC2626; font-weight: 600; margin: 4px 0; }
            ...
            <main className="main-content">
                <div className="column">
                    ...
                    <div className="card">
                        ...
                        <div className="snapshot-summary">
                            <div>
                                <p className="snapshot-label">Total Transactions</p>
                                <p className="snapshot-income">
                                    {totalTransactions}
                                </p>
                            </div>
                            <div>
                                <p className="snapshot-label">Average Expense</p>
                                <p className="snapshot-expense">
                                    ₹{averageExpense.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                </p>
                            </div>
                            <div>
                                <p className="snapshot-label">Highest Expense</p>
                                <p className="snapshot-expense">
