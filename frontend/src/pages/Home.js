    ...
    <div>
      ...
      <section style={styles.hero}>
        ...
        <p style={styles.heroText}>
          Manage your finances smartly with Expense logger. 
      ...
      <section style={styles.features}>
        <h2 style={{ fontSize: '2rem', fontWeight: '600', color: '#1f2937' }}>Why Choose Expense logger?</h2>
      ...
      <footer style={styles.footer}>
        <p>© 2026 Smart Expense logger | Built with MERN Stack</p>
      </footer>
    </div>
  );
};
